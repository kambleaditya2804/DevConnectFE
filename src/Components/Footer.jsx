...
const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content px-6 py-4 flex flex-col sm:flex-row items-center justify-between">
      <aside>
        <p className="font-bold text-xl text-gray-200 text-center sm:text-left pl-3 pb-2">
          DevConnect
          <br />
          <span className="text-sm font-bold text-gray-400">
            Empowering devs to connect and grow
          </span>
          <br />
      ...
      <div className="flex gap-4 my-6 sm:my-">
  =
        <a
          href=""
          target="_blank"
...
=
      ...
      <div className="text-right">
        <Link
          to="/about"
          className="text-gray-300 hover:text-green-400 transition font-bold text-lg pb-7 pr-5"
        >
          About Us
        </Link>
      </div>
